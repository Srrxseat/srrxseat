...
- บริการขนส่ง: เลือกตัวที่ค่าใช้จ่ายโดยประมาณถูกที่สุดในหน้านั้น
  (ถ้าอ่านราคาไม่ได้เลย จะถอยไปใช้ EXPRESS WORLDWIDE)
...
- `DHL_PICKUP_READY_TIME` = เวลาที่พัสดุพร้อมให้คูเรียร์เข้ารับ (ดีฟอลต์ `17:00`)
  ปลายช่วงใช้เวลาปิดรับของสาขาที่ DHL ให้มา ถ้าเวลาที่ตั้งเลยเวลาปิดรับจะข้ามไปพร้อมคำเตือน
